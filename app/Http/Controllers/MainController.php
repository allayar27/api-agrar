...
{
    private $all_comers = 0;
    private $late_comers = 0;
    ...
    public function index()
    {
        ...
        $teacheresStatistics = EducationDays::where('day', $day) ? EducationDays::where('date', $day)->first() : null;
        return $this->data([
            'all_students' => $students,
            'all_comers' => $this->all_comers,
            'late_comers' => $this->late_comers,
            'all_teachers' => $teacheresStatistics ? $teacheresStatistics->all_teachers : 0,
            'all_come_teachers' => $teacheresStatistics ? $teacheresStatistics->come_teachers : 0,
            'late_come_teachers' => $teacheresStatistics ? $teacheresStatistics->late_teachers : 0,
        ]);
    }
