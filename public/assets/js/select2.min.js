...
!function (n) {
    ...
    (u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs || (u ? e = u : u = {}, g = {}, m = {}, y = {}, v = {}, n = Object.prototype.hasOwnProperty, s = [].slice, _ = /\.js$/, h = function (e, t) {
    ...
    }).amd = {jQuery: !0}, u.requirejs = i, u.require = e, u.define = a), u.define("almond", function () {
        ...
        return d.Extend(s, d.Observable), s.prototype.render = function () {
            ...
            this.hideLoading();
            var t = [];
            if (null == e.results || 0 === e.results.length) 0 === this.$results.children().length && this.trigger("results:message", {message: "noResults"}); else {
            ...
            this.data.current(function (e) {
                ...
                t.$results.find(".select2-results__option--selectable").each(function () {
                    var e = u(this), t = d.GetData(this, "data"), n = "" + t.id;
            ...
            this.$results.attr("id", n), t.on("results:all", function (e) {
                ...
                var e, t, n = i.getHighlightedResults(), s = i.$results.find(".select2-results__option--selectable"),
                    n = s.index(n) + 1;
                ...
                var t = u(this), n = d.GetData(this, "data");
                t.hasClass("select2-results__option--selected") ? i.options.get("multiple") ? i.trigger("unselect", {
                    originalEvent: e,
                    data: n
                }) : i.trigger("close", {originalEvent: e, data: n}) : i.trigger("select", {originalEvent: e, data: n})
            ...
            var n = this.options.get("templateResult"), s = this.options.get("escapeMarkup"), n = n(e, t);
        ...
        return n.Extend(i, t), i.prototype.render = function () {
            ...
            var n = this, s = (i.__super__.bind.apply(this, arguments), t.id + "-container");
        ...
        return c.Extend(o, e), o.prototype.render = function () {
            ...
            var n = this, s = (o.__super__.bind.apply(this, arguments), e.id + "-container");
        ...
        return e.prototype.render = function (e) {
            var e = e.call(this), t = this.options.get("selectionCssClass") || "";
        ...
        return e.prototype.bind = function (e, t, n) {
            ...
            var i = this.tokenizer(t, this.options, function (e) {
                ...
                }).length || ((e = s.option(t)).attr("data-select2-tag", !0), s._removeOldTags(), s.addOptions([e])), s.trigger("select", {data: t})
            });
        ...
        return e.prototype.render = function (e) {
            var e = e.call(this), t = this.options.get("translations").get("search"),
        ...
        return e.prototype.bind = function (e, t, n) {
            ...
            var n = this, s = "scroll.select2." + t.id, i = "resize.select2." + t.id,
                t = "orientationchange.select2." + t.id, o = this.$container.parents().filter(r.hasScroll);
            o.each(function () {
            ...
            var r = this.$dropdown.outerHeight(!1), a = e.scrollTop(), e = e.scrollTop() + e.height(),
                a = a < i.top - r, e = e > i.bottom + r, i = {left: i.left, top: o.bottom}, l = this.$dropdownParent,
        ...
        return e.prototype.render = function (e) {
            var e = e.call(this), t = this.options.get("dropdownCssClass") || "";
            return -1 !== t.indexOf(":all:") && (t = t.replace(":all:", ""), n.copyNonInternalCssClasses(e[0], this.$element[0])), e.addClass(t), e
        }, e
        ...
        return e.prototype.highlightFirstItem = function (e) {
            ...
            if (0 < t.length) {
                var t = t.first(), n = s.GetData(t[0], "data").element;
        ...
        return n.prototype.apply = function (e) {
            ...
            var n = {}, e = (n[l.camelCase(e)] = t, f._convertData(n));
        ...
        var h = c.event.special.mousewheel = {
            version: "3.1.12", setup: function () {
                ...
                var e = c(e), t = e["offsetParent" in c.fn ? "offsetParent" : "parent"]();
        ...
        function s(e) {
            var t, n = e || window.event, s = p.call(arguments, 1), i = 0, o = 0, r = 0, a = 0, l = 0;
    ...
    }, "function" == typeof u.define && u.define.amd ? u.define("jquery-mousewheel", ["jquery"], i) : "object" == typeof exports ? module.exports = i : i(t), u.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function (i, e, o, t, r) {
        var a;
    ...
    var e, p, o, r, h, f, g, m, y, v, n, s, _, i, a = {define: u.define, require: u.require};
    ...
    function l(e, t) {
        var n, s, i, o, r, a, l, c, u, d, p = t && t.split("/"), h = y.map, f = h && h["*"] || {};
        if (e) {
